...
class Metrics(object):
    ...
    def write(self, out_folder):
        ...
        metrics_dir = os.path.join(out_folder, self.params['dataset'])
        os.makedirs(metrics_dir, exist_ok=True)

        file_name = 'metrics_{}_{}_{}_{}_{}.json'.format(self.params['seed'], self.params['optimizer'], self.params['learning_rate'], self.params['num_epochs'], self.params['mu'])

        full_path = os.path.join(metrics_dir, file_name)

        with open(full_path, 'w') as ouf:
